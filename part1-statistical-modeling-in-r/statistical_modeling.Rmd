...
- Requires distributional assumption for group-level parameters (e.g., individual-level parameters normally distributed around group-level parameters)
...
- Exercise 1.3: Analyse the data using the no-pooling approach: `exercises/exercise_1.3_P.Rmd`
