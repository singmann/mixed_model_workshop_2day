...
--
- Why is estimate of `binding_c` reduced by > 80% (was `r coef(m2)[2]`)?
--
...
.pull-left3[
```{r, eval=FALSE}
lm(reasoning ~ binding + updating, 
   ds_vb_18)   # a: 3
lm(reasoning ~ binding : updating, 
   ds_vb_18)   # b: 2
lm(reasoning ~ 0 + binding:updating, 
   ds_vb_18)   # c: 1
lm(reasoning ~ binding*updating, 
   ds_vb_18)   # d: 4
lm(reasoning ~ 0+binding*updating, 
...
lm(reasoning ~ binding, 
   ds_vb_18)   # f: 2
lm(reasoning ~ 0 + binding, 
   ds_vb_18)   # g: 1
```
